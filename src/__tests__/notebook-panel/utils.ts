...
export function createNotebookPanelWithSecondaryToolbar(context: Context<INotebookModel>): NotebookPanelWithSecondaryToolbar {
...
export function createNotebookWithSecondaryToolbarWidgetFactory(
    primaryToolbarFactory?: (widget: NotebookPanelWithSecondaryToolbar) => DocumentRegistry.IToolbarItem[],
    secondaryToolbarFactory?: (widget: NotebookPanelWithSecondaryToolbar) => DocumentRegistry.IToolbarItem[]
